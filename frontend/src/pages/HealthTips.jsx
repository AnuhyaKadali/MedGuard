...
<div style={{maxWidth:"1200px",margin:"auto",padding:"40px",color:"#0f172a"}}>
...
<p style={{marginTop:"10px",color:"#334155",fontSize:"18px",lineHeight:"1.6"}}>
...
<p style={{textAlign:"center",marginBottom:"30px",color:"#334155"}}>
...
Evidence Source: WHO healthy diet guidance
</p>
</div>
...
<p style={{marginTop:"10px",fontWeight:"bold",color:"#14532d"}}>{alt.name}</p>
<p style={{marginTop:"6px",fontSize:"13px",lineHeight:"1.4",color:"#365314"}}>{alt.benefits}</p>
